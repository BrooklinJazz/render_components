defmodule RenderComponentsNative do
  import RenderComponentsWeb, only: [verified_routes: 0]
  ...
  defp helpers(format) do
    ...
    core_component_module = Module.concat([RenderComponentsWeb, CoreComponents, plugin.module_suffix])
